...
## Working Directory
`/workspace/user_analysis/test_analysis3/` — write everything here. Do not touch files outside
this folder.
...
```bash
git -C /workspace add user_analysis/test_analysis3/
